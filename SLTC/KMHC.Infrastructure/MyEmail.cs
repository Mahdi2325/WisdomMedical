...
namespace KMHC.Infrastructure
{
    public class MyEmail
    {
        ...
        public MyEmail(string server, List<string> toMails, string fromMail, string subject, string emailBody, string username, string password, string port, bool sslEnable, bool pwdCheckEnable)
        {
            try
            {
                mMailMessage = new MailMessage();
                toMails.ForEach(toMail => mMailMessage.To.Add(toMail));
